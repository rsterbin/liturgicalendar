...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        calculate_from, church_year, algorithm, distance, weekday_precedence, continue_counting, schedule_pattern,
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'christmas', 0, 'days_after', 12, 45, false, 'standard-no-confessions',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        calculate_from, church_year, algorithm, distance, weekday_precedence, has_last_sunday, continue_counting, schedule_pattern,
        name_pattern_mon, name_pattern_tue, name_pattern_wed, name_pattern_thu,
        name_pattern_fri, name_pattern_sat, name_pattern_sat_vigil, name_pattern_sun,
        default_note_mon, default_note_tue, default_note_wed, default_note_thu,
        default_note_fri, default_note_sat, default_note_sun
    ) VALUES ('Ordinary Time After Epiphany', 'after-epiphany', 'green', 2,
        'easter', 1, 'tuesdays_before', 6, 60, true, false, 'standard',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 1, 'days_before', 8, 45, false, 'standard-stations',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 1, 'days_before', 1, 15, false, 'standard',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 1, 'days_after', 7, 15, false, 'standard-no-confessions',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 1, 'weeks_after', 7, 60, true, 'standard',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 1, 'weeks_after', 9, 60, false, 'standard',
        'Weekday', 'Weekday', 'Weekday', 'Weekday',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'christmas', 1, 'saturdays_before', 12, 60, true, 'standard-summer',
        'Weekday', 'Weekday', 'Weekday', 'Weekday',
        'Weekday', 'Weekday', 'Eve of the %s Sunday after Pentecost', 'The %s Sunday after Pentecost',
        NULL, NULL, NULL, NULL,
        'Friday Abstinence', NULL, NULL
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'christmas', 1, 'saturdays_before', 4, 60, true, true, 'standard',
        'Weekday', 'Weekday', 'Weekday', 'Weekday',
        'Weekday', 'Weekday', 'Eve of the %s Sunday after Pentecost', 'The %s Sunday after Pentecost',
        NULL, NULL, NULL, NULL,
        'Friday Abstinence', NULL, NULL
