...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'christmas-after', 'days_before', 1, 60, false, 'standard',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'christmas-before', 'days_after', 12, 45, false, 'standard-no-confessions',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 'tuesdays_before', 6, 60, true, false, 'standard',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 'days_before', 8, 45, false, 'standard-stations',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 'weeks_after', 7, 60, true, 'standard',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'easter', 'weeks_after', 9, 60, false, 'standard',
        'Weekday', 'Weekday', 'Weekday', 'Weekday',
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'christmas-after', 'saturdays_before', 12, 60, true, 'standard-summer',
        'Weekday', 'Weekday', 'Weekday', 'Weekday',
        'Weekday', 'Weekday', 'Eve of the %s Sunday after Pentecost', 'The %s Sunday after Pentecost',
        NULL, NULL, NULL, NULL,
        'Friday Abstinence', NULL, NULL
...
INSERT INTO liturigal_seasons (name, code, color, sort_order,
        ...
        'christmas-after', 'saturdays_before', 4, 60, true, true, 'standard',
        'Weekday', 'Weekday', 'Weekday', 'Weekday',
        'Weekday', 'Weekday', 'Eve of the %s Sunday after Pentecost', 'The %s Sunday after Pentecost',
        NULL, NULL, NULL, NULL,
        'Friday Abstinence', NULL, NULL
